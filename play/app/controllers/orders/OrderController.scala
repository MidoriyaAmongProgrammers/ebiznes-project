...
case class CreateOrderForm(date: String, coupon: Int, shipment: Int, payment: Int, user: String)
case class UpdateOrderForm(id: Int, date: String, coupon: Int, shipment: Int, payment: Int, user: String)
