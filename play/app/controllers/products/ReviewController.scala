...
case class CreateReviewForm(user: String, product: Int, content: String, rating: Int)
case class UpdateReviewForm(id: Int, user: String, product: Int, content: String, rating: Int)